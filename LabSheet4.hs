...
{-
    ...
    Only supports simple expressions of the form "int op int op int ...". No support for operator precendence or parenthesis. By default all four operators are left-associative and are of equal precedence.
